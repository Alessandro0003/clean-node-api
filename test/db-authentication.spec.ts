...
import { HashComparer, Encrypter, LoadAccountByEmailRepository, UpdateAccessTokenRepository, AccountModel, AuthenticationModel } from '../src/data/use-cases/authentication/db-authentication-protocols'
